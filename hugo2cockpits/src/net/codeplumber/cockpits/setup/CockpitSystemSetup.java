...
import net.codeplumber.cockpits.constants.Hugo2CockpitsConstants;
 ...
 */
@SystemSetup(extension = Hugo2CockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(Hugo2CockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(Hugo2CockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						Hugo2CockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/hugo2cockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
